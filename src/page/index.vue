            ...
            <div class = "fix_left h7">
              <div class = "chart_select">
                <div class = "t_sel" style="padding-top: 5%">
                  <el-select size="mini" v-model="value" @change = "monthlyIndex()">
                    <el-option
          ...
          <el-col :span="24">
            ...
            <div class = "fix_left h7">
              <div class = "chart_select">
                <el-row :gutter="5">
                  <el-col :span="8">
                    <div class = "t_tl" @click="quarterChange(1)" :class="quarter === 1 ? 't_tl_active' : ''">
                      十二大重点产业增加值
                    </div>
                  </el-col>
                  <el-col :span="9">
                    <div class = "t_tl" @click="quarterChange(2)" :class="quarter === 2 ? 't_tl_active' : ''">
                       城镇/农村居民可支配收入
                    </div>
                  </el-col>
                  <el-col :span="7">
                    <div class = "t_tl" @click="quarterChange(3)" :class="quarter === 3 ? 't_tl_active' : ''">
                        城镇新增就业人数
                    </div>
                  </el-col>
                </el-row>
          ...
          <el-col :span="24">
            ...
            <div class = "fix_left h7">
              <div class = "chart_select" style="width: 80%;margin-left: 10%">
                <el-row :gutter="10">
                  <el-col :span="4">
                    <div class = "t_tl" @click="antecedentChange(1)" :class="antecedent === 1 ? 't_tl_active' : ''">
                      PMI
                    </div>
                  </el-col>
                  <el-col :span="6">
                    <div class = "t_tl" @click="antecedentChange(2)" :class="antecedent === 2 ? 't_tl_active' : ''">
                      全行业用电量
                    </div>
                  </el-col>
                  <el-col :span="7">
                    <div class = "t_tl" @click="antecedentChange(3)" :class="antecedent === 3 ? 't_tl_active' : ''">
                      港口货运吞吐量
                    </div>
                  </el-col>
                  <el-col :span="7">
                    <div class = "t_tl" @click="antecedentChange(4)" :class="antecedent === 4 ? 't_tl_active' : ''">
                      新增银行贷款数
                    </div>
                  </el-col>
                </el-row>
          ...
          <el-col :span="24">
            <div class = "fix_center h10">
              <el-row>
                ...
                <el-col :span="6">
                  <div class = "center_lis" style="margin-top: 6vh"  @click="MacroBigDataChange(1)" :class="macro === 1 ? 'center_lis_active' : ''">
                    经济信心指数
                  </div>
                  <div class = "center_lis" @click="MacroBigDataChange(2)" :class="macro === 2 ? 'center_lis_active' : ''">就业压力指数</div>
                  <div class = "center_lis" @click="MacroBigDataChange(3)" :class="macro === 3 ? 'center_lis_active' : ''">双创热情指数</div>
                  <div class = "center_lis" @click="MacroBigDataChange(4)" :class="macro === 4 ? 'center_lis_active' : ''">投资意愿指数</div>
                  <div class = "center_lis" @click="MacroBigDataChange(5)" :class="macro === 5 ? 'center_lis_active' : ''">消费评价指数</div>
                </el-col>
                <el-col :span="18">
...
<script>
  ...
  export default {
    ...
    methods: {
      monthlyIndex(){
        this.chart_left1(this.value)
      },
      quarterChange(val){
        this.quarter = val;
      },
      antecedentChange(val){
        this.antecedent = val;
      },
      MacroBigDataChange(val){
        this.macro = val;
      },
      chart_left1(){
